$.ajax({
    ...
    success : function(data) {
     ...
     for(var i=0; i<data.length; i++) {
      ...
      c2.innerText = product.medicineName;
      c2.classList.add("column2");
      var c3 = document.createElement("td");
      c3.innerText = product.medicineBrand; 
      c3.classList.add("column3");
      var c4 = document.createElement("td");
      c4.innerText = product.expiryDate;
      c4.classList.add("column4");
      var c5 = document.createElement("td");
      c5.innerText ="$" + product.unitPrice;
      c5.classList.add("column5");
      var c6 = document.createElement("td");
      c6.innerText = product.stock;
      c6.classList.add("column6");
